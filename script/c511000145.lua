...
function c511000145.initial_effect(c)
    ...
    e8:SetOperation(c511000145.neglose)
    c:RegisterEffect(e8)
    --damage reduce
	...
	e10:SetCondition(c511000145.selfdcon)
	e10:SetOperation(c511000145.selfdop)
	c:RegisterEffect(e10)
end
function c511000145.selfdcon(e,tp,eg,ep,ev,re,r,rp)
	return re:IsHasType(EFFECT_TYPE_ACTIVATE) and re:GetHandler():IsCode(57585212) and Duel.IsChainDisablable(ev)
end
function c511000145.selfdop(e,tp,eg,ep,ev,re,r,rp)
	Duel.NegateEffect(ev)
	Duel.SetLP(e:GetHandler():GetControler(),1)
	Duel.SetLP(1-e:GetHandler():GetControler(),0)
end
...
function c511000145.neglose(e,tp,eg,ep,ev,re,r,rp)
	if e:GetHandler():IsStatus(STATUS_DISABLED) and Duel.GetLP(e:GetHandler():GetControler())<=1 and e:GetHandler():GetCounter(0x97)>0 then
		Duel.SetLP(e:GetHandler():GetControler(),0)
	end
end
