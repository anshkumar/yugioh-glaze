...
function c100000000.initial_effect(c)
	...
	e2:SetOperation(c100000000.sumsuc)
	c:RegisterEffect(e2)
	--Cannot be responded
	...
	e4:SetDescription(aux.Stringid(100000000,1))
	e4:SetCategory(CATEGORY_REMOVE+CATEGORY_DAMAGE)
	e4:SetType(EFFECT_TYPE_IGNITION)
	e4:SetRange(LOCATION_MZONE)
	e4:SetCost(c100000000.sgcost)
	e4:SetTarget(c100000000.sgtg)
	e4:SetOperation(c100000000.sgop)
	c:RegisterEffect(e4)
end
